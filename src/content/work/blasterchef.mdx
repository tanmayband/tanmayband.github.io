...
<ContentWithCaption src={BC2} caption="Parry potato, slice, fry and serve to adventurer"/>
...
<ContentWithCaption src={BC3} caption="Grapes, and minions made of potato"/>
...
<ContentWithCaption src={BC4} caption="Default: Normal static mesh replicates out of the box, but not Dynamic Mesh"/>
...
<ContentWithCaption src={BC5} caption="Replicate the slice operation, but sliced piece movement doesn't work"/>
...
<ContentWithCaption src={BC6} caption="Deterministic IDs allow for transform replication"/>
...
<ContentWithCaption src={BC7} caption="Server-client architecture"/>
